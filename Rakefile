module VIM
  Dirs = %w[ after autoload compiler doc plugin ruby snippets syntax ftdetect ftplugin colors indent templates ]
end
...
vim_plugin_task "jasmine",          "git://github.com/claco/jasmine.vim.git"
